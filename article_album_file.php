...
$articlemedia_info['articlemedia_date'] = date('d.m.Y', $articlemedia_info['articlemedia_date']);

$user_like = 0;
$count_likes = 0;
$likes = array();

if($articlemedia_info['media_likes'])$likes = unserialize($articlemedia_info['media_likes']);
...
$media_link = './article_album_file.php?article_id='.$article->article_info['article_id'].'&articlemedia_id='.$articlemedia_info['articlemedia_id'];
$media_thumb = $article->article_dir($article->article_info['article_id']).$articlemedia_info['articlemedia_id'].'_thumb.'.$articlemedia_info['articlemedia_ext'];
...
$mediasize = @getimagesize($article->url_articledir($article->article_info['article_id']).$articlemedia_info[articlemedia_id].'.'.$articlemedia_info[articlemedia_ext]);
$articlemedia_info[media_width] = $mediasize[0];
$articlemedia_info[media_height] = $mediasize[1];
if($articlemedia_info[media_width] > 528) {
    $articlemedia_info[media_width] = '528';
    $articlemedia_info[media_realwidth] = $mediasize[0];
}
