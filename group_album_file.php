...
/* $Id: group_album_file.php 161 2009-04-28 21:14:59Z john $ */
...
if($media_info[groupmedia_width] > 528) {
    $media_info[groupmedia_width] = '528';
    $media_info[groupmedia_realwidth] = $mediasize[0];
}
...
$media_info['groupalbum_datecreated'] = date('d.m.Y', $media_info['groupalbum_datecreated']);
...
$media_link = './group_album_file.php?group_id='.$group->group_info['group_id'].'&groupmedia_id='.$media_info['groupmedia_id'];
$media_thumb = $group->group_dir($group->group_info['group_id']).$media_info['groupmedia_id'].'_thumb.'.$media_info['groupmedia_ext'];
