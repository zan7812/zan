...
/* $Id: misc_js.php 130 2009-03-21 23:36:57Z john $ */
...
elseif($task == "comment_get")
{
  ...
  foreach( $comments as $comment_index=>$comment_data )
  {
    ...
    (
      ...
      'comment_rank'                    => (string) $comment_data['comment_rank']
    );
  }
...
elseif($task == "comment_post")
{
  ...
  // POST COMMENT
$comment_info = $comment->comment_post($_POST['comment_body'], $_POST['comment_secure'], $object_title, $object_owner, $object_owner_id, $permission['object_privacy'], $_POST['comment_rank']);
