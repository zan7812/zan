...
//Закрываем от клиентов
if( $user->profile_info['profilevalue_20'] < 2) {
    $page = "error";
    $smarty->assign('error_header', 639);
    $smarty->assign('error_message', 690706075);
...
if($task == "doadd") {
  ...
  $article_competition = $_POST['article_competition'];
  ...
  if($is_error == 0) {
    ...
    $article_id = $new_article->article_create($article_title, $article_body, $articlecat_id, $article_date_start, $article_draft, $article_approved, $article_search, $article_privacy, $article_comments, $article_competition);
