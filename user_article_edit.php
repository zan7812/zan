...
if($task == "dosave") {
  ...
  $article_competition = censor($_POST['article_competition']);
  ...
  $article_competition = $article->article_info[article_competition];
