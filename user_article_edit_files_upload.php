...
$smarty->assign('file1_result', $file_result[file1]);
$smarty->assign('file2_result', $file_result[file2]);
$smarty->assign('file3_result', $file_result[file3]);
$smarty->assign('file4_result', $file_result[file4]);
$smarty->assign('file5_result', $file_result[file5]);
